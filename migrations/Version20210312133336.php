 ...
 */
final class Version20210312133336 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE manga (id INT AUTO_INCREMENT NOT NULL, serie_id INT DEFAULT NULL, nb_page INT NOT NULL, prix_manga INT NOT NULL, desc_manga MEDIUMTEXT DEFAULT NULL, chemin_image VARCHAR(255) DEFAULT NULL, INDEX IDX_765A9E03D94388BD (serie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE serie (id INT AUTO_INCREMENT NOT NULL, serie_editeur_id INT DEFAULT NULL, serie_cathegorie_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, etat TINYINT(1) NOT NULL, INDEX IDX_AA3A93346283F725 (serie_editeur_id), INDEX IDX_AA3A93342C241E0B (serie_cathegorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
